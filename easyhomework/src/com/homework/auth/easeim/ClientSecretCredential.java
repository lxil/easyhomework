...
public class ClientSecretCredential extends Credential {
	...
	public ClientSecretCredential(String clientID, String clientSecret, String role) {
		...
		if (role.equals(Constants.USER_ROLE_APPADMIN)) {
	...
	public Token getToken() {
		...
		if (null == token || token.isExpired()) {
			try {
				...
				ObjectNode tokenRequest = EasemobUtil.sendRequest(getTokenRequestTarget(), objectNode, null,
						Constants.METHOD_POST, headers);
